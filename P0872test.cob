       ...
       PROGRAM-ID. P0872test.
       ENVIRONMENT DIVISION. 
       INPUT-OUTPUT SECTION. 
       FILE-CONTROL. 
           SELECT   STUDFL   ASSIGN   TO "D0872.DAT"
              ORGANIZATION   LINE  SEQUENTIAL.
           SELECT   PRINTFL  ASSIGN   TO "PRINTER872TEST".
       DATA   DIVISION. 
       FILE   SECTION. 
       FD  STUDFL
       ...
       01  HD-1.
           ...
           03 FILLER         PIC X(20)   VALUE "  >>>>".
       01  HD-2.
           03 FILLER         PIC X(20)   VALUE "  CODE  AGE   SEX".
           03 FILLER         PIC X(20)   VALUE " WED  LOAD   COVERAG".
       ...
       000-START.
           MOVE  0  TO POINT-CNT
           OPEN  INPUT STUDFL   OUTPUT   PRINTFL
           ...
           PERFORM  UNTIL EOF-SW = "Y"
              ...
              ELSE
                 ADD   5  TO POINT-CNT
              END-IF
              COMPUTE  POINT-WK ROUNDED  =  INS-LOAD * 0.5
               IF POINT-WK > 3
                 MOVE  3  TO POINT-WK
              END-IF
              ...
              MOVE  INS-WED        TO DL-M
              MOVE  INS-LOAD       TO DL-LOAD
              MOVE  INS-COVERAGE   TO DL-COVERAGE
